...
const PackersMovers = () => {
  ...
  const handleBooking = (service) => {
    addBooking({ ...service, category: "Packers and Movers" });
  ...
  return (
    <div className="guys-detail">
      ...
      <p>
        Choose from a variety of reliable packing and moving packages designed to ensure a smooth and secure relocation of your belongings.
        Our services cover household shifting, office relocation, vehicle transport, storage, specialized handling, and more.
      </p>
