  ...
  return (
    ...
    >
      ...
      <p className='Help' style={{ fontSize: "18px", marginBottom: "30px", textAlign: "center" }}>
        ...
        <strong style={{ color: "black" }}> Onlineservices</strong> 
        simple and stress‑free. Find answers to common questions below, or reach out to us directly.
      </p>

      <h2 style={{ color: "black", marginTop: "30px" }}>Frequently Asked Questions</h2>

      <h3 style={{ color: "black" }}> Booking & Scheduling</h3>
      ...
      <h3 style={{ color: "black" }}> Payments & Pricing</h3>
      <ul style={{ marginLeft: "20px" }}>
      ...
      <h2 style={{ color: "black", marginTop: "30px" }}>Service Guidelines</h2>
      <ul style={{ marginLeft: "20px" }}>
      ...
      <h2 style={{ color: "black", marginTop: "30px" }}>Troubleshooting</h2>
      <ul style={{ marginLeft: "20px" }}>
      ...
      <h2 style={{ color: "black", marginTop: "30px" }}>Contact Support</h2>
      <p>
      ...
      <h2 style={{ color: "black", marginTop: "30px" }}>Feedback & Suggestions</h2>
      <p>
